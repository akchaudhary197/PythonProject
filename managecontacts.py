...
class ManageContactsFrame(Frame):
    ...
    def create_view_all_contacts_frame(self):
        ...
        self.fill_contacts_treeview(query)
    ...
    def create_add_new_contact_frame(self):
        ...
        self.profile_pic_label = Label(self.add_new_contact_frame,
        text = "Profile Pic:")
    ...
    def create_update_delete_contact_frame(self, contact):
        ...
        self.profile_pic_label = Label(self.update_delete_contact_frame,
        text="Profile:")
        ...
        self.profile_pic.grid(row=0,column=1)

        self.profile_pic_button = Button(self.update_delete_contact_frame,
        text="Choose your profile pic",
        command=self.profile_pic_button_click)
        self.profile_pic_button.grid(row=1, column=1)
    ...
    def profile_pic_button_click(self):
        ...
        photo_name = self.name_entry.get().replace(" ", "")
        self.photo_path = "Photos/" + photo_name + "." + img.format
    ...
    def add_button_click(self):
        ...
        if record is None:
            ...
            "User of email id {0} is already added".format
            (self.email_id_entry.get()))

    def update_button_click(self):
        query = """update Contact set Name = '{0}', 
        PhoneNo = '{1}', EmailId = '{2}', 
        City = '{3}', PhotoPath = '{4}'
        where EmailId = '{5}'
        """.format(
